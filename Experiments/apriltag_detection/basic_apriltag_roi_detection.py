...
def drawAprilTagBorders(detection_item):
    corners = detection_item[i].corners
    x_coords = []
    y_coords = []
    ...
    center = detection_item[i].center
    plt.text(center[0], center[1], str(detection_item[i].tag_id), color='yellow', fontsize=12, ha='center')
...
def detect_apriltag_from_image(img_filepath):
